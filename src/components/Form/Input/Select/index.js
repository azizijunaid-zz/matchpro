...
export default class RNPickerSelect extends PureComponent {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        const itemsChanged = !_.isEqual(prevState.items, nextProps.items);
        ...
        const selectedItemChanged =
            !_.isEqual(nextProps.value, undefined) && !_.isEqual(prevState.selectedItem, selectedItem);
    ...
    getPlaceholderStyle() {
        ...
        if (!_.isEqual(placeholder, {}) && this.state.selectedItem.label === placeholder.label) {
            return {
